...
// const numbers = [25, 0, 1, 2, 13, 15, 190, 50];
// const foo = (arr) => arr.find(elem=> elem %2 === 0 )


// console.log(foo(numbers));

// Знаходження індексу елемента:
// Створіть функцію, яка приймає масив та елемент і повертає індекс цього елемента в масиві
//(або - 1, якщо елемент не знайдено).


// const numb = 1190
// const numbers = [25, 0, 1, 2, 13, 15, 190, 50];
// const foo = (arr, number) => arr.indexOf(numb);


// console.log(foo(numbers, numb));

// Сортування об'єктів за властивістю:
// Створіть функцію, яка приймає масив об'єктів і сортує їх за певною властивістю
//(наприклад, вік чи ім'я).
...
//   { id: 1, name: 'John', age: 25 },
//   { id: 2, name: 'Anna', age: 30 },
//   { id: 3, name: 'Boba', age: 22 }
// ];

// const foo = (arr1) => arr1.toSorted((a,b) => b.age - a.age)


// console.log(foo(users2));
